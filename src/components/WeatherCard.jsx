    ...
    <article className="weather">
      ...
      <section className="weather__body">
        ...
        <article className="weather__condition">
          <h3 className="weather__decription">
            {weather?.weather[0].description}
          </h3>
          <ul className="weather__list">
            <li className="weather__item">
              <span className="weather__title-item">Wind speed</span>
              <span>{weather?.wind.speed}m/s</span>
            </li>
            <li className="weather__item">
              <span className="weather__title-item">Clouds</span>
              <span>{weather?.clouds.all}%</span>
            </li>
            <li className="weather__item">
              <span className="weather__title-item">Pressure</span>
